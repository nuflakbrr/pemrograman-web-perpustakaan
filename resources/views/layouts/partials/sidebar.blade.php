<aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="{{ route('dashboard') }}" class="navbar-brand">
            ...
            <h4 class="logo-title">Perpustakaan</h4>
        </a>
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'kategori.index' ? 'active' : '' }}"
                        aria-current="page" href="{{ route('kategori.index') }}">
                        <i class="icon">
                        ...
                        <span class="item-name">Kategori Buku</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'buku.index' ? 'active' : '' }}"
                        aria-current="page" href="{{ route('buku.index') }}">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Str::startsWith(Route::currentRouteName(), 'anggota') ? 'active' : '' }}"
                        ...
                        <span class="item-name">Anggota</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item static-item">
                    <a class="nav-link static-item disabled" href="#" tabindex="-1">
                        <span class="default-icon">Peminjaman</span>
                        <span class="mini-icon">-</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'peminjaman.index' ? 'active' : '' }}"
                        ...
                        <span class="item-name">Peminjaman Buku</span>
                    </a>
                </li>
            </ul>
            <!-- Sidebar Menu End -->

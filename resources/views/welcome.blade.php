...
<body class="uikit" data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
    ...
    <div class="wrapper">
        ...
        <div class="header"
            style="background: url({{ asset('/assets/images/dashboard/top-image.jpg') }}); background-size: cover; background-repeat: no-repeat; height: 100vh;position: relative;">
            <div class="main-img">
                <div class="container">
                    <svg class="icon-150" width="150" viewBox="0 0 55 55" fill="none"
                    ...
                    <h4 class="mb-5 text-white">Production ready FREE Open Source <b>Dashboard UI Kit</b> and <b>Design
                            System</b>.</h4>
                    <div class="d-flex justify-content-center align-items-center">
                        <div>
                            <a class="bg-white btn btn-light d-flex" target="_blank" href="./dashboard/index.html">
                                <svg width="22" class="me-1 icon-22" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="ms-3">
                            <a class="bg-white btn btn-light d-flex" target="_blank"
                                href="https://github.com/iqonicdesignofficial/hope-ui-design-system"><img
                                    src="./assets/images/brands/23.png" width="24px" height="24px"><span
                            ...
                            <ul class="mb-2 navbar-nav ms-auto mb-lg-0 d-flex align-items-start">
                                <li class="nav-item">
                                    <a class="nav-link" aria-current="page"
                                        href="https://templates.iqonic.design/hope-ui/documentation/html/dist/main/"
                                        target="_blank">Documentation</a>
                                </li>
                                <li class="nav-item me-3">
                                    <a class="nav-link" aria-current="page"
                                        href="https://templates.iqonic.design/hope-ui/documentation/html/dist/main/change-log.html"
        ...
        <div class="container body-class-1">
            <aside
                class="mb-5 mobile-offcanvas bd-aside card iq-document-card sticky-xl-top text-muted align-self-start"
                id="left-side-bar">
                    ...
                    <ul class="mb-0 list-unstyled">
                        <li class="mt-2">
                            ...
                            <ul class="list-unstyled ps-3 collapse" id="components-collapse" style="">
                                <li><a class="rounded nav-link d-inline-flex align-items-center"
                        ...
                        <li class="my-2">
                            ...
                            <ul class="list-unstyled ps-3 collapse" id="forms-collapse" style="">
                                ...
                                <li><a class="rounded nav-link d-inline-flex align-items-center"
                                        href="#toggle-btn">Toggle Button</a></li>
                                <li><a class="rounded nav-link d-inline-flex align-items-center"
                    ...
                    <article id="accordion">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/components/accordion.html"
                                            target="_blank">
                        ...
                        <div class="card iq-document-card iq-doc-head">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane bd-heading-1 fade show" id="content-accordion-code"
                                    role="tabpanel">
                        ...
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/components/alert.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <div class="tab-content">
                                <div class="tab-pane bd-heading-1 fade show active" id="content-alert-prv"
                                    ...
                                    <div class="bd-example">
                                        ...
                                        <div class="mb-3 alert alert-top alert-info alert-dismissible fade show"
                                            role="alert">
                                            <span> This is a info alert—check it out!</span>
                                            <button type="button" class="btn-close btn-close-white"
                                                data-bs-dismiss="alert" aria-label="Close"></button>
                                        </div>
                                        <div class="mb-3 alert alert-right alert-warning alert-dismissible fade show"
                                            role="alert">
                        ...
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/components/badge.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <div class="tab-content">
                                <div class="tab-pane bd-heading-1 fade show active" id="content-badge-prv"
                                    ...
                                    <div class="bd-example">
                                        ...
                                        <p class="h5">Example heading <span class="badge bg-warning">New</span>
                                        </p>
                    ...
                    <article id="breadcrumb">
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/components/breadcrumb.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="card iq-document-card">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane bd-heading-1 fade show" id="content-Breadcrumb-code"
                                    role="tabpanel">
                                    <div class="section-block">
                                        <pre><code class="language-markup"> &#x3C;div class=&#x22;bd-example&#x22;&#x3E;
            &#x3C;nav aria-label=&#x22;breadcrumb&#x22;&#x3E;
                    ...
                    <article id="buttons">
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/components/buttons.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="card iq-document-card">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane bd-heading-1 fade show" id="content-Button-code"
                                    role="tabpanel">
                                    <div class="section-block">
                                        <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
        &#x3C;button type=&#x22;button&#x22; class=&#x22;btn btn-primary&#x22;&#x3E;Primary&#x3C;/button&#x3E;
                        ...
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/components/buttongroup.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-Buttongroup-prv"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link d-flex align-items-center" data-bs-toggle="tab"
                                            data-bs-target="#content-Buttongroup-code" type="button"
                        ...
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/plugins/flatpickr.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-Calendar-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-card-prv" type="button"
                            ...
                            <div class="tab-content">
                                            ...
                                            <div class="col">
                                                <div class="mb-0 card">
                                                    <svg class="bd-placeholder-img card-img-top" width="100%"
                                                        ...
                                                        <text x="40%" y="50%" fill="#dee2e6" dy=".3em">Image
                                                            cap</text>
                                                    </svg>
                                                    <div class="card-body">
                                ...
                                <div class="tab-pane bd-heading-1 fade show" id="content-card-code"
                                    role="tabpanel">
                                    <div class="section-block">
                                        <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
            &#x3C;div class=&#x22;row  row-cols-1 row-cols-md-2 g-4&#x22;&#x3E;
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-Carousel-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item">
                                                    <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100"
                                                        ...
                                                        <text x="46%" y="50%" fill="#555" dy=".3em">First
                                                            slide</text>
                                                    </svg>
                                                ...
                                                <div class="carousel-item active">
                                                    <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100"
                                                        ...
                                                        <text x="46%" y="50%" fill="#444" dy=".3em">Second
                                                            slide</text>
                                                    </svg>
                                                ...
                                                <div class="carousel-item">
                                                    <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100"
                                                        ...
                                                        <text x="46%" y="50%" fill="#333" dy=".3em">Third
                                                            slide</text>
                                                    </svg>
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-dropdown-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                ...
                                <div class="tab-pane bd-heading-1 fade show active" id="content-dropdown-prv"
                                    ...
                                    <div class="bd-example">
                                        <div class="flex-wrap btn-group w-100 align-items-center">
                                            <div class="dropdown">
                                                <button class="btn btn-gray btn-sm dropdown-toggle me-2"
                                            ...
                                            <div class="dropdown">
                                                <button class="btn btn-gray btn-lg dropdown-toggle me-2"
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-listgroup-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                ...
                                <div class="tab-pane bd-heading-1 fade show active" id="content-listgroup-prv"
                                    ...
                                    <div class="bd-example">
                                        <div class="list-group">
                                            ...
                                            <a href="#"
                                                class="list-group-item list-group-item-action list-group-item-gray">A
                                                simple Gray list group item</a>
                                        </div>
                                    </div>
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-Modal-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="tab-content">
                                <div class="tab-pane bd-heading-1 fade show active" id="content-Modal-prv"
                                    role="tabpanel">
                                    <div class="bd-example">
                                ...
                                <div class="tab-pane bd-heading-1 fade show" id="content-Modal-code"
                                    role="tabpanel">
                                    <div class="section-block">
                                        <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-Navs-prv" type="button"
                                            role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="tab-content">
                                <div class="tab-pane bd-heading-1 fade show active" id="content-Navs-prv"
                                        ...
                                        <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                                ...
                                                <p><strong>This is some placeholder content the Home tab's associated
                                                    ...
                                                    it with tabs, pills, and any other <code>.nav</code>-powered
                                                    navigation.</p>
                                            </div>
                                    ...
                                    <div class="bd-example">
                                        <ul class="nav nav-pills" data-toggle="slider-tab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active d-flex align-items-center"
                                                    data-bs-toggle="tab" data-bs-target="#pills-home1"
                                                    type="button" role="tab"
                                                    aria-selected="true">Home</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link d-flex align-items-center"
                                                    data-bs-toggle="tab" data-bs-target="#pills-profile1"
                                                    type="button" role="tab"
                                                    aria-selected="false">Profile</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                ...
                                <div class="tab-pane bd-heading-1 fade show" id="content-Navs-code"
                                    role="tabpanel">
                                    <div class="section-block">
                                        <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
            &#x3C;nav class=&#x22;nav&#x22;&#x3E;
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-Navbar-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="bd-example">
                                        ...
                                        <nav class="mt-5 navbar navbar-expand-lg navbar-dark bg-danger rounded-1">
                                            <div class="container-fluid">
                                                <a class="navbar-brand" href="#">Logo</a>
                                                <button class="navbar-toggler" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#navbar-22"
                                                    aria-controls="navbar-22" aria-expanded="false"
                                                    aria-label="Toggle navigation">
                                                    <span class="navbar-toggler-icon"></span>
                                                </button>
                                ...
                                <div class="tab-pane bd-heading-1 fade show" id="content-Navbar-code"
                                    role="tabpanel">
                                    <div class="section-block">
                                        <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
            &#x3C;nav class=&#x22;navbar navbar-expand-lg navbar-light bg-light&#x22;&#x3E;
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-Offcanvas-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                ...
                                <div class="tab-pane bd-heading-1 fade show active" id="content-Offcanvas-prv"
                                    ...
                                    <div class="bd-example">
                                        ...
                                        <button class="btn btn-primary mt-2" type="button"
                                            ...
                                            aria-controls="offcanvasLeft">Toggle left
                                            offcanvas</button>

                                        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasLeft"
                                            aria-labelledby="offcanvasLeftLabel">
                                            <div class="offcanvas-header">
                                                <h5 class="offcanvas-title" id="offcanvasLeftLabel">Offcanvas Left
                                                </h5>
                                                <button type="button" class="btn-close text-reset"
                                                    data-bs-dismiss="offcanvas" aria-label="Close"></button>
                                            </div>
                                        ...
                                        <button class="btn btn-primary mt-2" type="button"
                                            ...
                                            aria-controls="offcanvasScroll">Toggle
                                            Scroll offcanvas</button>

                                        <div class="offcanvas offcanvas-start" tabindex="-1"
                                            data-bs-scroll="true" id="offcanvasScroll"
                                            aria-labelledby="offcanvasScrollLabel">
                                            <div class="offcanvas-header">
                                                <h5 class="offcanvas-title" id="offcanvasScrollLabel">Offcanvas
                                                    Scroll
                                                </h5>
                                                <button type="button" class="btn-close text-reset"
                                                    data-bs-dismiss="offcanvas" aria-label="Close"></button>
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-Pagination-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link d-flex align-items-center" data-bs-toggle="tab"
                                            data-bs-target="#content-Pagination-code" type="button"
                                            role="tab" aria-selected="false">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-Popover-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane bd-heading-1 fade show" id="content-Popover-code"
                                    role="tabpanel">
                                    <div class="section-block">
                                        <pre><code class="language-markup"> &#x3C;div class=&#x22;bd-example&#x22;&#x3E;
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-progress-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <div class="bd-example">
                                        ...
                                        <div class="progress" style="height:10px">
                                            <div class="progress-bar bg-danger progress-bar-striped"
                                                role="progressbar" style="width: 40%; height:10px"
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-Scrollspy-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-Spinners-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-Toasts-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="p-5 bd-example bg-dark align-items-center">
                                        <div class="toast fade show" role="alert" aria-live="assertive"
                                            ...
                                            <div class="toast-header">
                                                <svg class="rounded bd-placeholder-img me-2 icon-20" width="20"
                                    ...
                                    <div class="p-5 bd-example bg-dark align-items-center">
                                        <div class="toast fade show align-items-center" role="alert"
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <button type="button" class="m-auto btn-close me-2"
                                ...
                                <div class="tab-pane bd-heading-1 fade show" id="content-Toasts-code"
                                    role="tabpanel">
                                    <div class="section-block">
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-Tooltips-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                ...
                                <div class="tab-pane bd-heading-1 fade show active" id="content-Tooltips-prv"
                                    ...
                                    <div class="bd-example tooltip-demo">
                                        ...
                                        <button type="button" class="btn btn-gray" data-bs-toggle="tooltip"
                                            ...
                                            bottom</button>
                                        <button type="button" class="btn btn-gray" data-bs-toggle="tooltip"
                                            data-bs-placement="left" title="Tooltip on start">Tooltip on
                                            start</button>
                                        <button type="button" class="btn btn-gray" data-bs-toggle="tooltip"
                                            data-bs-html="true"
                        ...
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    <h5>Overview</h5>
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="p-0 d-flex disabled btn"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/main/"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="card iq-document-card iq-doc-head">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-form-prv" type="button"
                                            role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane bd-heading-1 fade show" id="content-form-code"
                                    role="tabpanel">
                                    <div class="section-block">
                                        <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
        &#x3C;form&#x3E;
                        ...
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/forms/disable-forms.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-disabled-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                            ...
                                            <fieldset disabled="" aria-label="Disabled fieldset example">
                                                ...
                                                <fieldset class="mb-3">
                                                    ...
                                                    <div class="form-check">
                                                        <input type="radio" name="radios"
                                                            class="form-check-input" id="disabledRadio1"
                                                            disabled="">
                                                    ...
                                                    <div class="mb-3 form-check">
                                                        <input type="radio" name="radios"
                                                            class="form-check-input" id="disabledRadio2"
                                                            disabled="">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" class="form-control"
                                                        id="disabledCustomFile" disabled="">
                                                </div>
                                                <div class="mb-3 form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                        ...
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/forms/sizing.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-sizing-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane bd-heading-1 fade show" id="content-sizing-code"
                                    role="tabpanel">
                                    <div class="section-block">
                                        <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
        &#x3C;div class=&#x22;mb-3&#x22;&#x3E;
                        ...
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/forms/input-group.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-inputgroup-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link d-flex align-items-center" data-bs-toggle="tab"
                                            data-bs-target="#content-inputgroup-code" type="button"
                                            role="tab" aria-selected="false">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div class="mt-5 mb-3 bd-heading sticky-xl-top align-self-start mt-xl-0 mb-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/forms/alternate-input.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-alternet-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/forms/floating-lable.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-floating-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div class="mt-5 mb-3 bd-heading sticky-xl-top align-self-start mt-xl-0 mb-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/forms/alternate-float-lable.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-alternetfloat-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link d-flex align-items-center" data-bs-toggle="tab"
                                            data-bs-target="#content-alternetfloat-code" type="button"
                                            role="tab" aria-selected="false">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="tab-content">
                                <div class="tab-pane bd-heading-1 fade show active" id="content-alternetfloat-prv"
                                    ...
                                    <div class="bd-example">
                                        <div
                                            class="mb-3 form-floating custom-form-floating custom-form-floating-sm form-group">
                                            <input type="email" class="form-control" id="floatingInput11"
                                                placeholder="Place Holder">
                                            <label for="floatingInput11">Small</label>
                                        </div>
                                        <div class="mb-3 form-floating custom-form-floating form-group">
                                            <input type="email" class="form-control" id="floatingInput12"
                                                placeholder="Place Holder">
                                            <label for="floatingInput12">Regular</label>
                                        </div>
                                        <div
                                            class="mb-3 form-floating custom-form-floating custom-form-floating-lg form-group">
                                            <input type="email" class="form-control" id="floatingInput13"
                                                placeholder="Place Holder">
                                            <label for="floatingInput13">Large</label>
                                        </div>
                                        <div class="mb-3 form-floating custom-form-floating form-group">
                                            <input type="email" class="form-control" disabled
                                                id="floatingInput14" placeholder="Place Holder">
                                            <label for="floatingInput14">Regular</label>
                                        </div>
                                        <div class="mb-3 form-floating custom-form-floating form-group">
                                            <input type="email" class="form-control is-valid"
                                                id="floatingInput15" placeholder="Place Holder">
                                            <label for="floatingInput15">Regular</label>
                                        </div>
                                        <div class="mb-3 form-floating custom-form-floating form-group">
                                            <input type="email" class="form-control is-invalid"
                                                id="floatingInput16" placeholder="Place Holder">
                        ...
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/forms/toggle-button.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-toggle-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="bd-example">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="checkbox" class="form-check-input" id="customCheck8"
                                                checked="" disabled="">
                                            <label class="pl-2 form-check-label" for="customCheck8">Disabled
                                                Checked</label>
                                        </div>
                                    </div>
                                    <div class="bd-example">
                                        ...
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label for="radio3" class="pl-2 form-check-label">Active -
                                                Disabled</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input type="radio" class="form-check-input" name="bsradio1"
                                                id="radio4" disabled="">
                                            <label for="radio3" class="pl-2 form-check-label">Inactive -
                                                Disabled</label>
                                        </div>
                                    </div>
                                    <div class="bd-example">
                                        ...
                                        <div class="form-check form-switch form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="switch3"
                                                disabled />
                                            <label class="pl-2 form-check-label" for="switch3">Disabled
                                                Switch</label>
                                        </div>
                                        <div class="form-check form-switch form-check-inline">
                                ...
                                <div class="tab-pane bd-heading-1 fade show" id="content-toggle-code"
                                    role="tabpanel">
                                    <div class="section-block">
                                        <pre><code class="language-markup"> &#x3C;div class=&#x22;bd-example&#x22;&#x3E;
        &#x3C;div class=&#x22;form-check form-check-inline&#x22;&#x3E;
                        ...
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/forms/validation.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-validation-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link d-flex align-items-center" data-bs-toggle="tab"
                                            data-bs-target="#content-validation-code" type="button"
                                            role="tab" aria-selected="false">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/contents/typography.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="card iq-document-card iq-doc-head">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-typo-op" type="button"
                                            role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane bd-heading-1 fade show" id="content-typo-code"
                                    role="tabpanel">
                                    <div class="section-block">
                                        <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
        &#x3C;p class=&#x22;display-1&#x22;&#x3E;Display 1&#x3C;/p&#x3E;
                        ...
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/contents/images.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-image-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <div class="bd-example">
                                        <svg class="bd-placeholder-img bd-placeholder-img-lg img-fluid"
                                            ...
                                            <rect width="100%" height="100%" fill="#868e96"></rect><text
                                                x="40%" y="50%" fill="#dee2e6" dy=".3em">Responsive
                                                image</text>
                                        </svg>
                                    </div>
                                    <div class="bd-example">
                                        <svg class="bd-placeholder-img img-thumbnail" width="200"
                                            ...
                                            <rect width="100%" height="100%" fill="#868e96"></rect><text
                                                x="33%" y="50%" fill="#dee2e6" dy=".3em">200x200</text>
                                        </svg>
                                    </div>
                                </div>
                                <div class="tab-pane bd-heading-1 fade show" id="content-image-code"
                                    role="tabpanel">
                                    <div class="section-block">
                                        <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
                        ...
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/contents/tables.html"
                                            target="_blank">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-table-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link d-flex align-items-center" data-bs-toggle="tab"
                                            ...
                                            aria-selected="false">
                                            <svg class="icon-20" width="20" class="me-1"
                                                viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M4 2.00004C4 1.44776 4.44771 1.00004 5 1.00004L13.5721 1C13.8454 1 14.1068 1.11184 14.2955 1.30953L19.7234 6.99588C19.9009 7.18191 20 7.42919 20 7.68636V22C20 22.5523 19.5523 23 19 23H5C4.44772 23 4 22.5523 4 22V2.00004Z"
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane bd-heading-1 fade show" id="content-table-code"
                                    role="tabpanel">
                                    <div class="section-block">
                        ...
                        <div class="bd-heading sticky-xl-top align-self-start">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <a class="d-flex"
                                            href="https://templates.iqonic.design/hope-ui/documentation/html/dist/contents/figures.html"
                                            target="_blank">
                                            <svg width="20" class="me-1" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M12 21.2498C17.108 21.2498 21.25 17.1088 21.25 11.9998C21.25 6.89176 17.108 2.74976 12 2.74976C6.892 2.74976 2.75 6.89176 2.75 11.9998C2.75 17.1088 6.892 21.2498 12 21.2498Z"
                                                    stroke="currentColor" stroke-width="1.5"
                        ...
                        <div class="card iq-document-card">
                            <div class="d-flex justify-content-end">
                                <ul class="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active d-flex align-items-center"
                                            data-bs-toggle="tab" data-bs-target="#content-figure-prv"
                                            type="button" role="tab" aria-selected="true">
                                            <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="tab-content">
                                <div class="tab-pane bd-heading-1 fade show active" id="content-figure-prv"
                                    ...
                                    <div class="bd-example">
                                        <figure class="figure">
                                            <svg class="rounded bd-placeholder-img figure-img img-fluid"
                                                width="400" height="300" xmlns="http://www.w3.org/2000/svg"
                                                role="img" aria-label="Placeholder: 400x300"
                                                preserveAspectRatio="xMidYMid slice" focusable="false">
                                                <title>Placeholder</title>
                                                <rect width="100%" height="100%" fill="#868e96"></rect><text
                                                    x="42%" y="50%" fill="#dee2e6" dy=".3em">400x300</text>
                                            </svg>
                                ...
                                <div class="tab-pane bd-heading-1 fade show" id="content-figure-code"
                                    role="tabpanel">
                                    <div class="section-block">
                                        <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
            &#x3C;figure class=&#x22;figure&#x22;&#x3E;
        ...
        <div id="back-to-top" style="display: none;">
            <a class="p-0 btn btn-primary btn-sm position-fixed top" id="top" href="#top">
                <svg class="icon-30" width="30" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M5 15.5L12 8.5L19 15.5" stroke="currentColor" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round"></path>
                </svg>
            </a>
        </div>
